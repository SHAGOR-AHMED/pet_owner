export default{
    ...
    //solaman role permission
 
    // //about section
    // isAbout(){
    //     return this.checkAnyRoleOfArray(['Administrator', 'About-View']);
    // },

    // hasAboutAddAccess(){
    //     return this.checkAnyRoleOfArray(['Administrator', 'About-Add']);
    // },

    // hasAboutEditAccess(){
    //     return this.checkAnyRoleOfArray(['Administrator', 'About-Edit']);
    // },
    
    // hasAboutDeleteAccess(){
    //     return this.checkAnyRoleOfArray(['Administrator', 'About-Delete']);
    // },
