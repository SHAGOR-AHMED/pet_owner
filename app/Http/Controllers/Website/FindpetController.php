...
class FindpetController extends Controller
{
    ...
    public function index(){
        ...
        $allData = Findpet::where('user_id', Auth::user()->id)->orderBy($sort_field, $sort_direction)
    ...
    public function store(Request $request){
        ...
        $data->found_location = $request->found_location;
